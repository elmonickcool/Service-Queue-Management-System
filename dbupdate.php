<html>
<title> City Health Office - Dog Bite Services</title>
<head>
...
<center>
    ...
    <h1 style="font-family:Tahoma">Dog Bite Services Division</h1>
</center>
<body bgcolor="#31E509">
<center>
<?php
$edit_id = $_GET['edit_key'];
$query = "Select * from queue where Counter = 'C4'";
...
while($row = mysql_fetch_row($result))
	{
	echo"<form name='input' action='dbedit.php' method='post' >";
