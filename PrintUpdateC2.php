...
mysql_select_db('cho') ;
$query = "UPDATE queue SET Priority = Priority + 1 WHERE counter = 'C2'";
...
$connection = mysql_connect('localhost','cityhealth','123');
mysql_select_db('cho') ;
$query = "INSERT INTO history(counter,priority) SELECT name,priority From queue WHERE Counter='C2'";
$result = mysql_query($query);
