...
mysql_select_db('cho') ;
$query = "UPDATE queue SET Priority = Priority + 1 WHERE counter = 'C1'";
...
$connection = mysql_connect('localhost','cityhealth','123');
mysql_select_db('cho') ;
$query = "INSERT INTO history(counter,priority) SELECT name,priority From queue WHERE Counter='C1'";
$result = mysql_query($query);
